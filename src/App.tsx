  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="w-80 bg-white border-r border-gray-200 p-6">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">Names</h2>
        ...
        <div className="space-y-2">
          {people.length === 0 ? (
            <p className="text-gray-500 text-center py-8">No names added yet</p>
          ) : (
            people.map((person) => (
              <div
                key={person.id}
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-8">
        <div className="text-center space-y-8">
          <h1 className="text-4xl font-bold text-gray-800">Name Shuffle</h1>
          
          {/* Selected Person Display */}
          <div className="h-64 flex items-center justify-center">
            {isShuffling ? (
              <div className="text-center">
                <div className="w-24 h-24 bg-gray-300 rounded-full flex items-center justify-center text-4xl animate-spin-slow mb-4">
                  🎲
                </div>
                <p className="text-xl text-gray-600">Shuffling...</p>
              </div>
              ...
              <div className="text-center animate-bounce-in">
                ...
                <p className="text-3xl font-bold text-gray-800">{selectedPerson.name}</p>
              </div>
            ) : (
              <div className="text-center text-gray-400">
                <div className="w-24 h-24 bg-gray-200 rounded-full flex items-center justify-center text-4xl mb-4 mx-auto">
                  👤
                </div>
          ...
          {people.length === 0 && (
            <p className="text-gray-500 text-lg">Add some names to get started</p>
          )}
        </div>
      </div>
    </div>
