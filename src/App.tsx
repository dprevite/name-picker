    ...
    <div className="min-h-screen bg-background flex relative">
      ...
      <div className="w-80 bg-card border-r border-border p-6 relative">
        ...
        {selectedPerson && showResult && (
          <div className={`absolute inset-0 ${selectedPerson.color} opacity-5 transition-opacity duration-500`}></div>
        )}
        {/* Add Name Input */}
          ...
          <div className="flex items-center justify-center">
            {isShuffling ? (
              ...
              <div className="text-center relative">
                ...
                <p className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-35 text-4xl md:text-5xl lg:text-6xl font-bold text-white z-20 animate-bounce-in drop-shadow-2xl">
                  {selectedPerson.name}
                </p>
              </div>
            ) : (
