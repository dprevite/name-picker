        ...
        <div className="text-center space-y-8">
          ...
          <div className="h-96 md:h-[32rem] lg:h-[36rem] flex items-center justify-center">
            {isShuffling ? (
              ...
              <div className="text-center">
                <div
                  className={`w-40 h-40 md:w-52 md:h-52 lg:w-60 lg:h-60 ${selectedPerson.color} rounded-full flex items-center justify-center text-7xl md:text-8xl lg:text-9xl mb-8 mx-auto shadow-2xl animate-bounce-and-grow-debug`}
                >
                  {selectedPerson.icon}
                </div>
